...
public class ArchitectRewardFactory extends AttributeRewardFactory {
    private static final List<AttributeRewardArgs> rewards = List.of(
        new AttributeRewardArgs("scaffolding_mobility_reward", CraftboundAttributes.SCAFFOLDING_MOBILITY::get, Operation.ADDITION),
        ...
        new AttributeRewardArgs("placement_reach_reward", ForgeMod.BLOCK_REACH::get, Operation.MULTIPLY_TOTAL)
    );
