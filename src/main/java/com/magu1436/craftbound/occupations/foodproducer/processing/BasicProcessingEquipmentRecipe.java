...
public final class BasicProcessingEquipmentRecipe extends ShapelessRecipe {
    ...
    public RecipeSerializer<?> getSerializer() {
        return CraftboundRecipeSerializers.BASIC_PROCESSING_EQUIPMENT.get();
    }
    ...
    private static ItemStack result(ResourceLocation id) {
        return switch (id.getPath()) {
            case "cooking_knife" -> new ItemStack(CraftboundItems.COOKING_KNIFE.get());
            case "hand_mill" -> new ItemStack(CraftboundItems.HAND_MILL.get());
            case "drying_rack" -> new ItemStack(CraftboundItems.DRYING_RACK.get());
            case "cooking_pot" -> new ItemStack(CraftboundItems.COOKING_POT.get());
            default -> new ItemStack(CraftboundItems.COOKING_TABLE.get());
        };
    }
