...
public class ExplorerRewardsFactory extends AttributeRewardFactory {
    private static final List<AttributeRewardArgs> rewards = List.of(
        ...
        new AttributeRewardArgs("sure_footed_reward", ForgeMod.STEP_HEIGHT_ADDITION::get, Operation.ADDITION),
